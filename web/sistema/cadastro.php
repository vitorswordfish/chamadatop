...
<head>
    ...
    <link rel="stylesheet" href="bts/bootstrap.css">
    <link rel="stylesheet" href="fts/css/font-awesome.min.css">
    <!-- Estilos Css Globais -->
  ...
  <section class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <form action="controllers/marcar_presenca.php" method="POST">
